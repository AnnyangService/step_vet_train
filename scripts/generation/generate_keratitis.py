...
def generate_images(
    outdir="/home/minelab/desktop/Jack/step_vet_train/datasets/generated/keratitis",
    network="",
    trunc=1.0,
    seeds="1-10",
    gpu_ids="0"
...
def main():
    model_path = "/home/minelab/desktop/Jack/step_vet_train/models/projected_gan/keratitis-gpus2-batch64/best_model.pkl"
