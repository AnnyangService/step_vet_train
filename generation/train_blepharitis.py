...
def main():
    ...
    cfg = "fastgan"
    data = "/home/minelab/desktop/Jack/step_vet_train/datasets/training_gan/blepharitis"
    gpus = 2  
    batch = 64 
    mirror = 1
    snap = 50
    ...
    # 특정 체크포인트 파일 직접 지정
    checkpoint_path = "/home/minelab/desktop/Jack/step_vet_train/training_log/blepharitis-gpus2-batch64/best_model.pkl"
